...
<?php
	...
	$db = new Connection();
	$db -> dbConnect();
	$query = "SELECT s.smsid,t.name,s.mobile_no,".		// fetch log from DB from tables SMSIDS anD SMS_SENT_LOG of about sending and clicking event
				"CONVERT_TZ(t.date_created,'+0:00', '+5:30') sent_date, CONVERT_TZ(s.date_created,'+0:00', '+5:30') clicked_date".
			" FROM  smsids s, sms_sent_log t".
			" WHERE s.smsid=t.smsid ORDER BY  s.date_created DESC";
	// echo $query;
